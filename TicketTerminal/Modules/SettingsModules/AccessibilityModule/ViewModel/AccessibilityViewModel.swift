...
final class AccessibilityViewModel: ObservableObject {
    ...
    internal func setFontColor(_ color: AccessibilityFontColor, action: @escaping () -> Void) {
    ...
    internal func setFontSize(_ size: AccessibilityFontSize, action: @escaping () -> Void) {
